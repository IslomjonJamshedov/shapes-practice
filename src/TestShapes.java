...
public class TestShapes {
    public static void main(String[] args) {
        ...
        if (square.area() > circle.area() && square.area() > rectangle.area())
            System.out.println("Square has the largest area as " + square.area());
        else if (circle.area() > square.area() && circle.area() > rectangle.area())
            System.out.println("Circle has the largest area as " + circle.area());
        else System.out.println("Rectangle has the largest area as " + rectangle.area());
